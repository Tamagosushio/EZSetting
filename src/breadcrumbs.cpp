...
void BreadcrumbComponent::SetEntries(const std::vector<std::string>& new_entries) {
...
Element BreadcrumbComponent::OnRender() {
...
ftxui::ButtonOption BreadcrumbComponent::MakeFlatButtonOption() const {
